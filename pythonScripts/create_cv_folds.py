...
def cross_validate(in_tsv:Path, out_path:Path, k:int, tf:str, random_state:int|None=None) -> None:
    '''
    ...
    Arguments:
        ...
        out_path: Path to the output directory for fold files
    ...
    for fold in range(k):
        ...
        fold_file = out_path / f"{in_tsv.stem}_{tf}_fold{fold+1}.tsv"
